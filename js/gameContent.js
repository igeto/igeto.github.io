            ...
            <section class="fragment">
                <div class="row">
                    <div class="col">
                        ...
                        <p><i>Според податоци од светска здравствена организација аномалиите на плодот и здравствените проблеми на родителите се најчестите причини за смртност на плодот.Според податоци од светска здравствена организација аномалиите на плодот и здравствените проблеми на родителите се најчестите причини за смртност на плодот.</i></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
    ...
    <section class="fragment">
                <div class="row">
                    <div class="col">
                        ...
                        <p><i>Според податоци од светска здравствена организација аномалиите на плодот и здравствените проблеми на родителите се најчестите причини за смртност на плодот. Проблеми во бременоста може да предизвикаат и одредени лекови или користење на дроги.</i></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                ...
                <div class="col">
                    <div class="card ">
                        <div class="card-block">
                            ...
                            <p><i>Според податоците од Државниот завод за статистика во 2016 година, бројот на <strong>мртвородени</strong> бебиња изнесува <strong>195</strong>, додека во  првата година од животот <strong>починале 273 доенчиња.</strong></i></p>
                            <p><i>Според податоците од институтот за јавно здравје, во Македонија <strong>бројот на  жени кои умреле</strong> во текот на бременоста, породувањето или кратко по породувањето <strong>изнесува 145</strong> во 2015 година.</i></p>
                        </div>
                    </div>
                    <button id="" class="btn btn-primary appointmentBtn restartBtn" data-toggle="modal" data-target="#myModal">Обидете се повторно</button>
                </div>
            ...
            <section class="fragment">
                <div class="row">
                    ...
                    <div class="col">
                        <div class="card btnDescription">
                            <div class="card-block">
                                <p class="card-text">Вашиот ехо наод укажува на сериозни здравствени нарушувања, гинекологот ви препорачува да ја прекинете бременоста</strong>.</p>
                            </div>
